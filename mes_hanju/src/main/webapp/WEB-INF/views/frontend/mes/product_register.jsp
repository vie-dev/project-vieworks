	...
	<jsp:include page="/common/sidebar_menu_inc" flush="true">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					MES <small>생산계획확정</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> MES</a></li>
					<li class="active">생산계획확정</li>
				</ol>
			</section>
...
<!-- 									<button type="button" id="btn_test" class="btn btn-primary btn-sm" onclick = "test();" style="display:none;">테스트</button> -->
<!-- 									<button type="button" id="btn_test" class="btn btn-primary btn-sm" onclick = "test();">테스트</button> -->
									<button type="button" id="btn_confirm" class="btn btn-primary btn-sm">확정</button>
									<button type="button" id="btn_non_confirm" class="btn btn-primary btn-sm">미확정</button>
...
<!-- 											<label>  -->
<!-- 												<input type="radio" name="rdo_prod_confirm_chk" class="flat-red" value="" checked> -->
<!-- 												전체 -->
<!-- 											</label>  -->
<!-- 											<label>  -->
<!-- 												<input type="radio" name="rdo_prod_confirm_chk" class="flat-red" value="p2"> 확정 -->
<!-- 											</label>  -->
<!-- 											<label>  -->
<!-- 												<input type="radio" name="rdo_prod_confirm_chk" class="flat-red" value="p1"> 미확정 -->
<!-- 											</label> -->
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-12 text-left" style="font-weight:bold;">
										<i class="fa fa-check" aria-hidden="true"></i> 지시일의 검색 단위는 일주일 입니다.</div>
								</div>
							</div>
