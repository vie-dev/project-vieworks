    ...
    <body class="hold-transition skin-green-light sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>EIS<small>지역별 판매</small></h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> EIS</a></li><li class="active">지역별 판매</li>
                    </ol>
                </section>
        ...
        <script type="text/javascript">
            ...
            function makeGridUrl() {
                return "/eis/zmpfm_co003_rt_output05"
                        + "?IV_GJAHR=" + $("#ym_date").val()
                        + "&IV_GSBER=" + $("#sel_scope_cd").val();
            }

            function makeChartUrl() {
                return "/eis/zmpfm_co003_rt_output05_graph"
                        + "?IV_GJAHR=" + $("#ym_date").val()
                        + "&IV_GSBER=" + $("#sel_scope_cd").val();
            }
            ...
            function fnLoadGrid() {
                ...
                $("#grid").jqGrid('setGroupHeaders', {
                    ...
                    groupHeaders: [
                        {startColumnName: 'bztxt', numberOfColumns: 1, titleText: ''},
        ...
        <script type="text/javascript">
            ...
            var chartLayout =
                    ...
                    + '<series>'
                    + '<Pie2DSeries nameField="bztxt" field="amnt_sum" labelPosition="inside" color="#ffffff" startAngle="136">'
                    + '<showDataEffect>'
