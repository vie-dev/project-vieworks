    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>
					품질관리 <small> 수입검사진행현황(업체별)</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> 품질관리 </a></li>
                    <li class="active">수입검사진행현황(업체별)</li>
                </ol>
            </section>
...
function fnSearchInspGrid() {
	...
	var page_url = "/frontend/qm/import_inspection_state_select";
...
function fnLoadInspGrid() {
	$("#grid_role").jqGrid({
		datatype : "json",
		colNames : ['업체코드', '업체명', '전체 입고 Lot 수', '검사대상Lot 수', '검사완료 건수', '합격건수', '불합격건수', '합격율(%)'],
		colModel : [
			{name : 'lifnr',index : 'lifnr',width : 10,sorttype : "text",sorttype:'text'},
			{name : 'name1',index : 'name1',width : 10, align:"right", sorttype:'text'}, 
