...
function loadGroupMaster() {
	var page_url = "/frontend/mes/select_v_selfinsp_master"
...
// 	console.log('loadHeader()');
	...
	var page_url = "/frontend/mes/select_v_selfinsp_header_list"
...
// 	console.log('loadDetail()');
	...
	var selectGroup = w2ui.grid_group.get(w2ui.grid_group.getSelection())[0];
	var page_url = "/frontend/mes/select_v_selfinsp_detail_list"
				 + "?simaster_gr_no=" + encodeURIComponent(selectGroup.simaster_gr_no);
// 				 + "&matnr=" + encodeURIComponent(selectGroup.matnr);
...
// 	console.log('insertGroup()');
	...
	var page_url = '/frontend/mes/v_selfInspMaster_insert'
...
// 	console.log('checkMatnr()');
	var page_url = '/frontend/mes/v_checkDuplicateMatnr'
				 + '?matnr=' + encodeURIComponent($("#g_matnr_int").val());
	var returnObj = null;
	$.ajax({
		url : page_url,
...
// 	console.log('updateGroupInfo()');
	...
	var page_url = '/frontend/mes/v_selfInspMaster_update'
...
// 	console.log(updateData);
	var page_url = '/frontend/mes/v_update_selfinsp_header'
...
// 	console.log('updateData-->');
// 	console.log(updateData);
	var page_url = '/frontend/mes/v_update_selfinsp_detail'
				 + '?insertData=' + encodeURIComponent(JSON.stringify(insertData))
				 + '&updateData=' + encodeURIComponent(JSON.stringify(updateData));
	$.ajax({
		url : page_url,
