...
<title>MHE - Viewer</title>

<link rel="shortcut icon" href="/res/images/common/v_favicon.ico">

<link rel="stylesheet" href="/res/plugins/pdf/viewer.css" />
<script src="/res/plugins/pdf/compatibility.js"></script>

<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="/res/plugins/pdf/locale/locale.properties" />

<script src="/res/plugins/pdf/l10n.js"></script>
<script src="/res/plugins/pdf/pdf.js"></script>

<script src="/res/plugins/pdf/debugger.js"></script>
