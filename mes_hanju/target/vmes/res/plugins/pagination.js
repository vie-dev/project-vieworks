...
//		code += " class='disabled'";
	...
	if( page==1 )
		...
		code += "	      <a href='javascript:loadList(1)' aria-label='First'>          ";
...
//		code += " class='disabled'";
	...
	if( page==1 )
		...
		code += "	      <a href='javascript:loadList("+prePageNum+")' aria-label='Previous'>          ";
...
//		console.warn(page, printNum, totalPage);
		if( printNum <= totalPage ){
			...
			if( page==printNum )
				code += " class='active'";
			code += "><a href='javascript:loadList(" + printNum + ")';>" + printNum + "</a></li>                    ";
		}
	}
	...
	if( page==totalPage )
		...
		code += "	      <a href='javascript:loadList(" + nextPageNum + ")' aria-label='Next'>              ";
	...
	if( page==totalPage )
		...
		code += "	      <a href='javascript:loadList(" + totalPage + ")' aria-label='Last'>              ";
